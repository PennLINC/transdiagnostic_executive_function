...
for model_type in MODEL_TYPES:
    firstlevel_dir = Path(f"/cbica/projects/executive_function/code/task_contrast/final/results_no_motion_polynomials/first-level/nback-{model_type}")
    for contrast_label in CONTRAST_LABELS:
        ...
        group_out_dir = Path(
            f"/cbica/projects/executive_function/code/task_contrast/final/results_no_motion_polynomials/second-level/nback-{model_type}/group-{contrast_label}"
        )
