...
for model_type in MODEL_TYPES:
    firstlevel_dir = Path(f"/cbica/projects/executive_function/code/task_contrast/final/results_troubleshoot2/first-level/nback-{model_type}")
    for contrast_label in CONTRAST_LABELS:
        ...
        group_out_dir = Path(
            f"/cbica/projects/executive_function/code/task_contrast/final/results_troubleshoot2/second-level/nback-{model_type}/group-{contrast_label}"
        )
