...
coverage_df <- read.csv('/Users/bsevchik/Documents/GitHub/transdiagnostic_executive_function/QC/qc_csvs/full_concatenated_csvs/concat_xcpd_qc_coverage_row_sums_pass_fail.csv')
coverage_df
```
