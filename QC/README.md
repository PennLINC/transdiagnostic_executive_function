...
+ `qc_scripts/create_T1_QC_mni_slices.sh` creates the slices used to manually evaluate T1 scans for QC, and `qc_scripts/display_T1_QC_slices.ipynb` and visually displays these slices.
