...
native_path = os.path.join(fmriprep_anat_path, 'QC/T1w_space-native/') #CUBIC project path
...
for f in range(len(file_list)):
    ...
    dataTypes = ['_desc-preproc_T1w.nii.gz']
