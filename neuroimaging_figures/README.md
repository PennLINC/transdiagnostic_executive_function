+ `aslprep_figures` contains the ASL CBF maps that were then formatted in Adobe Illustrator and used for figure 9 in the manuscript.
+ `diffusion_figures` contains the scalar maps for DWI data that were then formatted in Adobe Illustrator and used for figure 7 in the manuscript.
