...
cubids_summary <- read.delim('/Users/bsevchik/Documents/GitHub/transdiagnostic_executive_function/curation/03_cubids_curation/final_cubids_docs/v50_summary.tsv', header = TRUE, stringsAsFactors = FALSE) # local path - replace
