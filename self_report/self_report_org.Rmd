...
scales <- list(
  ...
  ALS18      = c("als18", "als18_complete"),
  ARI        = c("ari_proband_complete", "ari"),
  ASRM       = c("asrm", "asrm_complete"),
  BDI        = c("bdi1a_child", "beck_depression_inventory_modified_child_bdi1a_complete"),
  ...
  RPAS       = c("rpas", "rpas_complete"),
  RSAS       = c("rsas", "rsas_complete"),
  Substance  = c("substance", "substance_complete"),
...
for (scale in names(scales)) {
  ...
  # Drop unwanted columns with "collateral" or "_c"
  keep_cols <- keep_cols[!grepl("collateral|_c", keep_cols, ignore.case = TRUE)]
