...
html_file <- "/Users/bsevchik/projects/EF_final_figures/01_input/R_fig2_participants/sankey_plot.html"
svg_file  <- "/Users/bsevchik/projects/EF_final_figures/01_input/R_fig2_participants/sankey_plot.svg"
pdf_file  <- "/Users/bsevchik/projects/EF_final_figures/01_input/R_fig2_participants/sankey_plot.pdf"

saveWidget(sankey_plot, file = html_file, selfcontained = TRUE)

b <- ChromoteSession$new()
on.exit(b$close(), add = TRUE)
b$Page$navigate(paste0("file://", normalizePath(html_file)))
b$wait_for_load_event()

svg_txt <- b$Runtime$evaluate('document.querySelector("svg").outerHTML')$result$value
