...
# ------------------------------------------------------------
# NO RTDur MODEL:
# just rename trial types to valid identifiers
#   0BACK -> zero_back
#   2BACK -> two_back
# ------------------------------------------------------------
renamed_events_list = []
for events in events_list:
    ...
    renamed_events_list.append(events)
...
model = model.fit(
    run_imgs,
    events=renamed_events_list,   # <-- no RTDur augmentation
...
# ============================================================
# SAVE SEPARATE 2-BACK AND 0-BACK CONTRASTS
# ============================================================
...
save_glm_to_bids(
    ...
    out_dir=output_dir / "derivatives" / "nilearn_glm_SEPARATE_noRTDur",
